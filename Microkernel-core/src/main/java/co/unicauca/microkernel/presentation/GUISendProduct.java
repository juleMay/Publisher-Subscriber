...
public class GUISendProduct extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Indique la dirreción");
        jPanel1.add(jLabel6);
        jPanel1.add(jTextField6);

        jLabel7.setText("Indique la ciudad");
        jPanel1.add(jLabel7);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        deliveryEntity = new Delivery(selectedProduct,
        ...
        try {
            ...
            deliveryEntity.setAddress(jTextField6.getText());
            deliveryEntity.setCity(jTextField7.getText());
            deliveryEntity.setPrice(cost);
