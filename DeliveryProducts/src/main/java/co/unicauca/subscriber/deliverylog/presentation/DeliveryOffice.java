...
public class DeliveryOffice extends javax.swing.JFrame implements ISubscriber {
    ...
    public void onMessage(String msg) {
      ...
      modelList.addElement("Id: " + deliveryEntity.getProduct().getProductId() + ", Nombre: " + deliveryEntity.getProduct().getName() +
      ", Precio: " + deliveryEntity.getPrice() + ", Dirección de destino: " + deliveryEntity.getAddress() +
      ", Ciudad: " + deliveryEntity.getCity() + ", País: " + deliveryEntity.getCountryCode());
